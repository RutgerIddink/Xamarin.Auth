...
using OneTimeSetUp = Core.Testing.UnitTests.UnitTestsCompatibilityAliasAttribute;
// XUnit aliases
using TestClass = Core.Testing.UnitTests.UnitTestsCompatibilityAliasAttribute;
#elif NUNIT
