...
using Xamarin.Auth.Compat.Cryptography;
#else
using Xamarin.Auth.Compat._MobileServices;
using Xamarin.Auth.Compat._MobileServices.Cryptography;
#endif

#if !AZURE_MOBILE_SERVICES
namespace Xamarin.Auth.Compat.AccountUtilities
#else
namespace Xamarin.Auth.Compat._MobileServices.AccountUtilities
#endif
{
    /// <summary>
    /// Account manager.
