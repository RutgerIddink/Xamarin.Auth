...
namespace Xamarin.Auth.Compat
{
    public partial class Account
    {
        ...
        public virtual System.Net.CookieContainer Cookies { [System.Runtime.CompilerServices.CompilerGeneratedAttribute]get 
            { 
                //Unable to resolve assembly 'Assembly(Name=System.Net.Primitives, Version=3.9.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a)' referenced by 'Assembly(Name=Xamarin.Auth.Compat, Version=1.5.0.0, Culture=neutral, PublicKeyToken=null, Location=./source/Core/Xamarin.Auth.Compat.Portable/bin/Debug/Xamarin.Auth.Compat.dll)'.
        ...
        { [System.Runtime.CompilerServices.CompilerGeneratedAttribute]
            get 
            { 
                //Unable to resolve assembly 'Assembly(Name=System.Collections, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a)' referenced by 'Assembly(Name=Xamarin.Auth.Compat, Version=1.5.0.0, Culture=neutral, PublicKeyToken=null, Location=./source/Core/Xamarin.Auth.Compat.Portable/bin/Debug/Xamarin.Auth.Compat.dll)'.
        ...
        public static Xamarin.Auth.Compat.Account Deserialize(string serializedString) { return default(Xamarin.Auth.Compat.Account); }
    ...
    public abstract partial class AccountStore
    {
        ...
        public static Xamarin.Auth.Compat.AccountStore Create() { return default(Xamarin.Auth.Compat.AccountStore); }
        public static Xamarin.Auth.Compat.AccountStore Create(string password) { return default(Xamarin.Auth.Compat.AccountStore); }
        public abstract void Delete(Xamarin.Auth.Compat.Account account, string serviceId);
        public abstract System.Threading.Tasks.Task DeleteAsync(Xamarin.Auth.Compat.Account account, string serviceId);
        public abstract System.Collections.Generic.IEnumerable<Xamarin.Auth.Compat.Account> FindAccountsForService(string serviceId);
        public abstract System.Threading.Tasks.Task<System.Collections.Generic.List<Xamarin.Auth.Compat.Account>> FindAccountsForServiceAsync(string serviceId);
        public abstract void Save(Xamarin.Auth.Compat.Account account, string serviceId);
        public abstract System.Threading.Tasks.Task SaveAsync(Xamarin.Auth.Compat.Account account, string serviceId);
    }
    public partial class AccountStoreException : Xamarin.Auth.Compat.AuthException
    {
    ...
    public partial class AuthenticationUI
    {
        ...
        public static Xamarin.Auth.Compat.AuthenticationUIType AuthenticationUIType 
        { 
            [System.Runtime.CompilerServices.CompilerGeneratedAttribute]get 
            { return default(Xamarin.Auth.Compat.AuthenticationUIType); } [System.Runtime.CompilerServices.CompilerGeneratedAttribute]set { } }
    }
    ...
    public abstract partial class Authenticator
    {
        ...
        public System.Func<Xamarin.Auth.Compat.Account, Xamarin.Auth.Compat.AccountResult> GetAccountResult { [System.Runtime.CompilerServices.CompilerGeneratedAttribute]get { return default(System.Func<Xamarin.Auth.Compat.Account, Xamarin.Auth.Compat.AccountResult>); } [System.Runtime.CompilerServices.CompilerGeneratedAttribute]set { } }
        ...
        public event System.EventHandler<Xamarin.Auth.Compat.AuthenticatorCompletedEventArgs> Completed { add { } remove { } }
        public event System.EventHandler<Xamarin.Auth.Compat.AuthenticatorErrorEventArgs> Error { add { } remove { } }
        public static void ClearCookies() { }
        [System.Diagnostics.DebuggerStepThroughAttribute]
        //[System.Runtime.CompilerServices.AsyncStateMachineAttribute(typeof(Xamarin.Auth.Compat.Authenticator.<ClearCookiesAsync>d__43))]
        ...
        public void OnSucceeded(Xamarin.Auth.Compat.Account account) { }
        public override string ToString() { return default(string); }
    }
    public partial class AuthenticatorCompletedEventArgs : System.EventArgs
    {
        public AuthenticatorCompletedEventArgs(Xamarin.Auth.Compat.Account account) { }
        public Xamarin.Auth.Compat.Account Account { [System.Runtime.CompilerServices.CompilerGeneratedAttribute]get { return default(Xamarin.Auth.Compat.Account); } }
    ...
    public abstract partial class FormAuthenticator : Xamarin.Auth.Compat.Authenticator
    {
        ...
        public System.Collections.Generic.IList<Xamarin.Auth.Compat.FormAuthenticatorField> Fields { [System.Runtime.CompilerServices.CompilerGeneratedAttribute]get { return default(System.Collections.Generic.IList<Xamarin.Auth.Compat.FormAuthenticatorField>); } [System.Runtime.CompilerServices.CompilerGeneratedAttribute]set { } }
        public string GetFieldValue(string key) { return default(string); }
        public abstract System.Threading.Tasks.Task<Xamarin.Auth.Compat.Account> SignInAsync(System.Threading.CancellationToken cancellationToken);
    }
    public partial class FormAuthenticatorField
    {
        public FormAuthenticatorField() { }
        public FormAuthenticatorField(string key, string title, Xamarin.Auth.Compat.FormAuthenticatorFieldType fieldType, string placeholder="", string defaultValue="") { }
        public Xamarin.Auth.Compat.FormAuthenticatorFieldType FieldType { [System.Runtime.CompilerServices.CompilerGeneratedAttribute]get { return default(Xamarin.Auth.Compat.FormAuthenticatorFieldType); } [System.Runtime.CompilerServices.CompilerGeneratedAttribute]set { } }
    ...
    public static partial class OAuth1
    {
        ...
        {
            //Unable to resolve assembly 'Assembly(Name=System.Net.Requests, Version=3.9.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a)' referenced by 'Assembly(Name=Xamarin.Auth.Compat, Version=1.5.0.0, Culture=neutral, PublicKeyToken=null, Location=./source/Core/Xamarin.Auth.Compat.Portable/bin/Debug/Xamarin.Auth.Compat.dll)'.
    ...
    public partial class OAuth1Authenticator : Xamarin.Auth.Compat.WebRedirectAuthenticator
    {
        public OAuth1Authenticator(string consumerKey, string consumerSecret, System.Uri requestTokenUrl, System.Uri authorizeUrl, System.Uri accessTokenUrl, System.Uri callbackUrl, Xamarin.Auth.Compat.GetUsernameAsyncFunc getUsernameAsync=null, bool isUsingNativeUI=false) : base (default(System.Uri), default(System.Uri)) { }
        public Xamarin.Auth.Compat.HttpWebClientFrameworkType HttpWebClientFrameworkType { [System.Runtime.CompilerServices.CompilerGeneratedAttribute]get { return default(Xamarin.Auth.Compat.HttpWebClientFrameworkType); } [System.Runtime.CompilerServices.CompilerGeneratedAttribute]set { } }
    ...
    public partial class OAuth1Request : Xamarin.Auth.Compat.Request
    {
        public OAuth1Request(string method, System.Uri url, System.Collections.Generic.IDictionary<string, string> parameters, Xamarin.Auth.Compat.Account account, bool includeMultipartsInSignature=false) : base (default(string), default(System.Uri), default(System.Collections.Generic.IDictionary<string, string>), default(Xamarin.Auth.Compat.Account)) { }
        protected virtual string GetAuthorizationHeader() { return default(string); }
        public override System.Threading.Tasks.Task<Xamarin.Auth.Compat.Response> GetResponseAsync(System.Threading.CancellationToken cancellationToken) { return default(System.Threading.Tasks.Task<Xamarin.Auth.Compat.Response>); }
    }
    public partial class OAuth2Authenticator : Xamarin.Auth.Compat.WebRedirectAuthenticator
    {
        public OAuth2Authenticator(string clientId, string clientSecret, string scope, System.Uri authorizeUrl, System.Uri redirectUrl, System.Uri accessTokenUrl, Xamarin.Auth.Compat.GetUsernameAsyncFunc getUsernameAsync=null, bool isUsingNativeUI=false) : base (default(System.Uri), default(System.Uri)) { }
        public OAuth2Authenticator(string clientId, string scope, System.Uri authorizeUrl, System.Uri redirectUrl, Xamarin.Auth.Compat.GetUsernameAsyncFunc getUsernameAsync=null, bool isUsingNativeUI=false) : base (default(System.Uri), default(System.Uri)) { }
        ...
        public Xamarin.Auth.Compat.OAuth2.State State { get { return default(Xamarin.Auth.Compat.OAuth2.State); } set { } }
        ...
        [System.Diagnostics.DebuggerStepThroughAttribute]
        //[System.Runtime.CompilerServices.AsyncStateMachineAttribute(typeof(Xamarin.Auth.Compat.OAuth2Authenticator.<RequestAccessTokenAsync>d__45))]
    ...
    public partial class OAuth2Request : Xamarin.Auth.Compat.Request
    {
        public OAuth2Request(string method, System.Uri url, System.Collections.Generic.IDictionary<string, string> parameters, Xamarin.Auth.Compat.Account account) : base (default(string), default(System.Uri), default(System.Collections.Generic.IDictionary<string, string>), default(Xamarin.Auth.Compat.Account)) { }
        ...
        public static System.Uri GetAuthenticatedUrl(Xamarin.Auth.Compat.Account account, System.Uri unauthenticatedUrl, string accessTokenParameterName="access_token") { return default(System.Uri); }
        public static string GetAuthorizationHeader(Xamarin.Auth.Compat.Account account) { return default(string); }
        protected override System.Uri GetPreparedUrl() { return default(System.Uri); }
    }
    public partial class Request
    {
        protected readonly System.Collections.Generic.List<Xamarin.Auth.Compat.Request.Part> Multiparts;
        public Request(string method, System.Uri url, System.Collections.Generic.IDictionary<string, string> parameters=null, Xamarin.Auth.Compat.Account account=null) { }
        public virtual Xamarin.Auth.Compat.Account Account { [System.Runtime.CompilerServices.CompilerGeneratedAttribute]get { return default(Xamarin.Auth.Compat.Account); } [System.Runtime.CompilerServices.CompilerGeneratedAttribute]set { } }
        ...
        //{ 
        //    //Unable to resolve assembly 'Assembly(Name=System.Net.Http, Version=1.5.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a)' referenced by 'Assembly(Name=Xamarin.Auth.Compat, Version=1.5.0.0, Culture=neutral, PublicKeyToken=null, Location=./source/Core/Xamarin.Auth.Compat.Portable/bin/Debug/Xamarin.Auth.Compat.dll)'.
        //    return default(System.Net.Http.HttpRequestMessage); 
        //}
        public virtual System.Threading.Tasks.Task<Xamarin.Auth.Compat.Response> GetResponseAsync() { return default(System.Threading.Tasks.Task<Xamarin.Auth.Compat.Response>); }
        [System.Diagnostics.DebuggerStepThroughAttribute]
        //[System.Runtime.CompilerServices.AsyncStateMachineAttribute(typeof(Xamarin.Auth.Compat.Request.<GetResponseAsync>d__23))]
        public virtual System.Threading.Tasks.Task<Xamarin.Auth.Compat.Response> GetResponseAsync(System.Threading.CancellationToken cancellationToken) { return default(System.Threading.Tasks.Task<Xamarin.Auth.Compat.Response>); }
    ...
    public partial class Response : System.IDisposable
    {
        ...
        { 
            // Unable to resolve assembly 'Assembly(Name=System.IO, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a)' referenced by 'Assembly(Name=Xamarin.Auth.Compat, Version=1.5.0.0, Culture=neutral, PublicKeyToken=null, Location=./source/Core/Xamarin.Auth.Compat.Portable/bin/Debug/Xamarin.Auth.Compat.dll)'.
    ...
    public abstract partial class WebAuthenticator : Xamarin.Auth.Compat.Authenticator
    {
    ...
    public static partial class WebEx
    {
        ...
        { 
            //Unable to resolve assembly 'Assembly(Name=System.Text.Encoding, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a)' referenced by 'Assembly(Name=Xamarin.Auth.Compat, Version=1.5.0.0, Culture=neutral, PublicKeyToken=null, Location=./source/Core/Xamarin.Auth.Compat.Portable/bin/Debug/Xamarin.Auth.Compat.dll)'.
return default(System.Text.Encoding); }
    ...
    public partial class WebRedirectAuthenticator : Xamarin.Auth.Compat.WebAuthenticator
    {
...
namespace Xamarin.Auth.Compat.OAuth2
{
    public partial class GrantType
    {
        public GrantType(Xamarin.Auth.Compat.OAuth2Authenticator a) { }
    }
    public partial class ResponseType
    {
        public ResponseType(Xamarin.Auth.Compat.OAuth2Authenticator a) { }
    }
...
namespace Xamarin.Auth.Compat.Presenters
{
    ...
    {
        public static System.Action<Xamarin.Auth.Compat.Authenticator> PlatformLogin;
        public OAuthLoginPresenter() { }
        public event System.EventHandler<Xamarin.Auth.Compat.AuthenticatorCompletedEventArgs> Completed { add { } remove { } }
        public void Login(Xamarin.Auth.Compat.Authenticator authenticator) { }
    }
}
