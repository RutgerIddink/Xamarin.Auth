...
#endif
{
    ...
    public static class WebViewConfiguration
    {
        ...
        {
            /// <summary>
            /// Gets or sets a value indicating whether this <see cref="T:Xamarin.Auth.Compat.WebAuthenticatorController"/> 
            ...
            static IOS()
            {
                ...
                sb.AppendLine($"Xamarin.Auth.Compat.WebViewConfiguration.IOS");
