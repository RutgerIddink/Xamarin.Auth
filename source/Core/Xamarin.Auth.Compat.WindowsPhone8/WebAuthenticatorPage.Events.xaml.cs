...
namespace Xamarin.Auth.Compat.WindowsPhone
#else
namespace Xamarin.Auth.Compat._MobileServices.WindowsPhone
#endif
{
    public partial class WebAuthenticatorPage
    {
        ...
        void auth_Completed(object sender, AuthenticatorCompletedEventArgs e)
        {
            if (NavigationService.CanGoBack)
            {
                ...
                //		https://github.com/xamarin/Xamarin.Auth.Compat/pull/94
