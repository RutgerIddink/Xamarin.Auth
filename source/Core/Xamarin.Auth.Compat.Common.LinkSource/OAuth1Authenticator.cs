...
#endif
{
    ...
    #endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Xamarin.Auth.Compat.OAuth1Authenticator"/> class.
        /// </summary>
            ...
            : base(authorizeUrl, callbackUrl)
        {
            ...
            this.HttpWebClientFrameworkType = Auth.Compat.HttpWebClientFrameworkType.WebRequest;
