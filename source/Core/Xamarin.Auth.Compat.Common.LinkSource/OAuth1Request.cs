...
#endif
{
    ...
    #endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Xamarin.Auth.Compat.OAuth1Request"/> class.
        /// </summary>
        /// <param name='method'>
        /// The HTTP method.
        /// </param>
        ...
        /// Parameters that will pre-populate the <see cref="Xamarin.Auth.Compat.Request.Parameters"/> property or <see langword="null"/>.
        /// </param>
        /// <param name='account'>
