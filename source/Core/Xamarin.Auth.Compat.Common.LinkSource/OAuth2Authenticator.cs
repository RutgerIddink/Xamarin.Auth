...
#endif
{
...
#endif
    {
        ...
        ///		https://github.com/xamarin/Xamarin.Auth.Compat/pull/91
        ///		
        ...
        ///		https://github.com/xamarin/Xamarin.Auth.Compat/pull/79
        ///		
        ...
        /// <summary>
        /// Initializes a new <see cref="Xamarin.Auth.Compat.OAuth2Authenticator"/>
        ...
        /// <summary>
        /// Initializes a new instance <see cref="Xamarin.Auth.Compat.OAuth2Authenticator"/>
            ...
            : base(redirectUrl, redirectUrl)
        {
            ...
            ///		https://github.com/xamarin/Xamarin.Auth.Compat/pull/59
        ...
        public override Task<Uri> GetInitialUrlAsync(Dictionary<string, string> custom_query_parameters = null)
        {
			...
			*/
            ...
            ///		https://github.com/xamarin/Xamarin.Auth.Compat/pull/57
            /*
                                                ...
                                                )
        {
            ...
            ///     https://github.com/xamarin/Xamarin.Auth.Compat/pull/62
            //Uri.EscapeDataString (scope),
            //{"scope", this.scope},
        ...
        */
        ...
        /// <remarks>By default, the <see cref="Xamarin.Auth.Compat.OAuth2Authenticator"/> escapes the 
