...
#endif
{
	...
	public class Response : IDisposable
	{
		...
		/// <summary>
		/// Initializes a new <see cref="Xamarin.Auth.Compat.Response"/> that wraps a <see cref="HttpResponseMessage"/>.
		/// </summary>
		/// <param name="response">
		...
		/// <summary>
		/// Initializes a new blank <see cref="Xamarin.Auth.Compat.Response"/>.
		/// </summary>
		protected Response ()
		{
		}
        ...
        /// <summary>
        /// Returns a <see cref="System.String"/> that represents the current <see cref="Xamarin.Auth.Compat.Response"/>.
        /// </summary>
        /// <returns>
        /// A <see cref="System.String"/> that represents the current <see cref="Xamarin.Auth.Compat.Response"/>.
        /// </returns>
		...
		/// <summary>
		/// Releases unmanaged resources and performs other cleanup operations before the <see cref="Xamarin.Auth.Compat.Response"/>
		...
		/// <summary>
		/// Releases all resource used by the <see cref="Xamarin.Auth.Compat.Response"/> object.
		/// </summary>
		public void Dispose ()
		{
			Dispose (true);
