...
#endif
{
    ...
    #endif
    {
        ...
        /// <summary>
        /// Gets or sets whether Xamarin.Auth.Compat should display login errors.
        /// </summary>
        /// <value><c>true</c> by default.</value>
...
#region
        ...
        ///		https://github.com/xamarin/Xamarin.Auth.Compat/pull/58
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Xamarin.Auth.Compat.Authenticator"/> class.
        /// </summary>
        ...
        public void OnSucceeded(Account account)
        {
            ...
            (
                delegate
                {
                    ...
                    {
                        msg = "No subscribers to Xamarin.Auth.Compat.Authenticator.Completed (OnCompleted) event";
                        System.Diagnostics.Debug.WriteLine(msg);
                    }
                }
            );
