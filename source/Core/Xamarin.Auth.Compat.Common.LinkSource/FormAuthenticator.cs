...
#endif
{
    ...
    #endif
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Xamarin.Auth.Compat.FormAuthenticator"/> class
    ...
    #endif
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Xamarin.Auth.Compat.FormAuthenticatorField"/> class.
		/// </summary>
		/// <param name='key'>
