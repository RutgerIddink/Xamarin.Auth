...
#endif
{
    ...
    #endif
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Xamarin.Auth.Compat.Request"/> class.
        /// </summary>
        /// <param name='method'>
        /// The HTTP method.
        /// </param>
		...
		*/
        ...
        /// <summary>
        /// Returns the <see cref="T:System.Net.HttpWebRequest"/> that will be used for this <see cref="T:Xamarin.Auth.Compat.Request"/>. All properties
