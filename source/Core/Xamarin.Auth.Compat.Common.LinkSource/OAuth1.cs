    ...
    #endif
    {
        ...
        public static string GetSignature(string method, Uri uri, IDictionary<string, string> parameters, string consumerSecret, string tokenSecret)
        {
			...
			string msg = 
				@"
					TODO: 
					Get-Project Xamarin.Auth.Compat.Portable | Install-Package System.Security.Cryptography.Hashing -Pre
					Get-Project Xamarin.Auth.Compat.Portable | Install-Package System.Security.Cryptography.Hashing.Algorithms -Pre
				";
			System.Diagnostics.Debug.WriteLine("Xamarin.Auth.Compat: " + msg);
            #endif
