...
#endif
{
    ...
    {
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="T:Xamarin.Auth.Compat.WebAuthenticator"/> 
        ...
        public bool IsUsingNativeUI
        {
            ...
            /*
                ...
                In Xamarin.Auth.Compat a lot of things happen already in ctor.... Even first requests...
            */ 
        }
