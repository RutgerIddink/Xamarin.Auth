...
#endif
{
    ...
    #endif
    {
        ...
        {
            Intent intent = new Intent(activity, typeof(Xamarin.Auth.Compat.WebViewActivity));
            intent.PutExtra(Xamarin.Auth.Compat.WebViewActivity.EXTRA_URL, uri.ToString());
            activity.StartActivity(intent);
