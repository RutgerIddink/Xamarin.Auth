...
[assembly:
    ExportRenderer
        (
            ...
            typeof(Xamarin.Auth.Compat.XamarinForms.XamarinAndroid.AuthenticatorPageRenderer)
        )
]
namespace Xamarin.Auth.Compat.XamarinForms.XamarinAndroid
{
    [global::Android.Runtime.Preserve(AllMembers = true)]
    public class AuthenticatorPageRenderer : Xamarin.Forms.Platform.Android.PageRenderer
    {
        protected Xamarin.Auth.Compat.Authenticator Authenticator = null;
        protected Xamarin.Auth.Compat.XamarinForms.AuthenticatorPage authenticator_page = null;
