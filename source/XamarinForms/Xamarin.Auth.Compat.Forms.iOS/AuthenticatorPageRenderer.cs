...
[assembly:
    ExportRenderer
        (
            ...
            typeof(Xamarin.Auth.Compat.XamarinForms.XamarinIOS.AuthenticatorPageRenderer)
        )
]
namespace Xamarin.Auth.Compat.XamarinForms.XamarinIOS
{
    ...
    #endif
    {
        ...
        public override void ViewDidAppear(bool animated)
        {
            if (oauth_was_shown)
            {
				// close Xamarin.Auth.Compat.XamarinForms.AuthenticatorPage
